---
title: "How to design a collection strategy for monitoring disinformation and hate speech in Telegram - preliminary results"
collection: talks
...
This poster presents preliminary results of the data collection strategy, which is currently being implemented and tested. We will share insights on the challenges faced during the data collection process, as well as the initial findings from the collected Telegram data. This work contributes to the broader effort of understanding and mitigating the spread of harmful content on social media platforms, particularly in environments with less regulation.
